...
and CAST(CONVERT(VARCHAR(10),temp.[Visit Start],101) as SMALLDATETIME) = CAST(CONVERT(VARCHAR(10),GETDATE(),101) as SMALLDATETIME)
--and temp.[Closure Date] is null
and temp.visit_type_rcd = 'V4'
)as tempb
order by tempb.[Visit Start] DESC