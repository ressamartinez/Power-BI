...
FROM api_patient_visit_view api 
			...
			left join patient_work_queue_entry pw on api.patient_visit_id = pw.patient_visit_id
            left join patient_wq_entry_type_ref pwtr on pw.patient_wq_entry_type_rcd = pwtr.patient_wq_entry_type_rcd
...
--and temp.[Visit No.] in ('2607028', '2598655')
and (temp.work_queue_type = 'Request' or temp.work_queue_type is null)
order by temp.[Visit Start]
